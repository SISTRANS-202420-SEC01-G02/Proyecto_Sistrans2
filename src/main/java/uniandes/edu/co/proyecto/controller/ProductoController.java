...
public class ProductoController {
    ...
    public ResponseEntity<String> guardarProducto(@RequestBody Producto producto){
        try{
            productoRepository.insertarProducto(producto.getNombre(), producto.getCostoBodega(), producto.getCostoUnidad(), producto.getPresentacion(), producto.getCantidadPresentacion(), producto.getUnidadMedida(), producto.getFechaExpiracion());
    ...
    public ResponseEntity<String> editarGuardarProducto(@PathVariable("codigoBarras") int codigoBarras, @RequestBody Producto producto){
        ...
        try{
            productoRepository.actualizarProducto(codigoBarras, producto.getNombre(), producto.getCostoBodega(), producto.getCostoUnidad(), producto.getPresentacion(), producto.getCantidadPresentacion(), producto.getUnidadMedida(), producto.getFechaExpiracion());
